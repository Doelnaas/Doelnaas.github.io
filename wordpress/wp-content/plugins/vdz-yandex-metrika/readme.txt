...
== Description ==
Установите плагин и сохраните ID (идентификатор состоящий из цифр) счетчика в секции "VDZ Yandex Metrika" кастомизации вашей темы, при смене темы - счетчик останется и будет работать дальше. Можете выбрать где выводить счетчик в Head или Footer (по умолчанию).
